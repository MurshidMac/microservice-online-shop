...
import com.vimo.demo.notification.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.vimo.demo.notification.domain.Notification}.
 */
@RestController
@RequestMapping("/api")
