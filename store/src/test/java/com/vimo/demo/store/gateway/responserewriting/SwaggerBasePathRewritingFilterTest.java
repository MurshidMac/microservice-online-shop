package com.vimo.demo.store.gateway.responserewriting;
...
import static com.vimo.demo.store.gateway.responserewriting.SwaggerBasePathRewritingFilter.gzipData;
