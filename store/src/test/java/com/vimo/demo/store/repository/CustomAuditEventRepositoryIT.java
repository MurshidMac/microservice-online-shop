package com.vimo.demo.store.repository;

import com.vimo.demo.store.StoreApp;
import com.vimo.demo.store.config.Constants;
import com.vimo.demo.store.config.audit.AuditEventConverter;
import com.vimo.demo.store.domain.PersistentAuditEvent;
...
import static com.vimo.demo.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
